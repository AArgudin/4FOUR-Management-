...
interface Props {
  artist: { name: string; instagramUrl: string; tiktokUrl: string; soundcloudUrl: string; spotifyUrl: string; appleMusicUrl?: string; youtubeUrl?: string }
  onClose: () => void
}
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          {!artist.soundcloudUrl && !artist.tiktokUrl && !artist.spotifyUrl && !artist.appleMusicUrl && !artist.youtubeUrl && (
